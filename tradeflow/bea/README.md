...
python bea/main.py --force-regen

# Get help on available parameters
python bea/main.py --help
```
...
interstate_id, trade_id, state_industry_code, flow_value, flow_type, employment_impact
...
**Generates:**
- `year/[year]/US/domestic/interstate_factor.csv` — state-to-state trade flows
  Columns: `interstate_id, trade_id, state_industry_code, flow_value, flow_type, employment_impact`
